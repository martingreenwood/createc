	...
	<div id="primary" class="content-area">
		...
		<div class="page-menu">
			...
			<div class="child-pages">
				<ul>
					<li><a href="<?php echo home_url( '/intelligent-solutions/case-studies' ); ?>">Back to Case Studies</a></li>
				</ul>
			</div>
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php get_template_part( 'template-parts/content', 'single-is-case-study' ); ?>
